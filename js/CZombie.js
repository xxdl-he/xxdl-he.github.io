var CZombies = function(b, a) {
		return (a = function() {}).prototype = {
			...
			Init: function(g, j, e, d) {
				...
				j.ArR = f;
				j.ArHTML = ['<div id="', '" style="position:absolute;visibility:', ";left:", "px;top:", "px;z-index:",
					'"><img src="' + ShadowPNG + '" style="' + j.getShadow(j) + '"><img style="position:absolute;clip:rect(0,auto,',
					",0);top:", 'px" src="' + j.PicArr[j.NormalGif] + '"></div>'
				]
			},
			...
			Die: function(d) {
				var e = this,
					f = e.id,
					c = $(f);
				!d ? (c.childNodes[1].src = e.PicArr[e.DieGif] + Math.random(), oSym.addTask(250, ClearChild, [c])) : d < 2 ? (c.childNodes[
					1].src = e.PicArr[e.BoomDieGif] + Math.random(), oSym.addTask(300, ClearChild, [c])) : ClearChild(c);
				e.HP = 0;
				delete $Z[f];
				oP.MonPrgs()
			},
			GoingDieHead: function(e, c, d) {
				oSym.addTask(200, ClearChild, [NewImg(0, c[d.HeadGif] + Math.random(), "left:" + d.AttackedLX + "px;top:" + (d.pixelTop -
					20) + "px;z-index:" + d.zIndex, EDAll)])
			},
			GoingDie: function(d) {
				var c = this,
					e = c.id;
			...
			JudgeAttack: function() {
				var g = this,
					...
					h = oGd.$,
					c;
				(c = g.JudgeLR(g, e, f, d, h) || g.JudgeSR(g, e, f, d, h)) ? c[0](c[1], c[2]): g.isAttacking && (g.isAttacking =
					0, $(g.id).childNodes[1].src = g.PicArr[g.NormalGif])
			},
			...
			NormalAttack: function(d, c) {
				...
				oSym.addTask(100, function(g, f) {
					var j = $Z[g],
						h;
					j && j.beAttacked && !j.FreeFreezeTime && !j.FreeSetbodyTime && ((h = $P[f]) && h.getHurt(j, j.AKind, !j.FreeSlowTime ?
						j.Attack : Math.round(j.Attack * 0.5)), j.JudgeAttack())
				}, [d, c])
			}
		}, a
	}(),
	...
	oZombie = InheritO(OrnNoneZombies, {
		...
		PicArr: (function() {
			...
			return [a + "Zombie.gif", a + "ZombieAttack.gif", a + "ZombieLostHead.gif", a + "ZombieLostHeadAttack.gif", a +
				"ZombieHead.gif" + $Random, a + "ZombieDie.gif" + $Random, a + "BoomDie.gif" + $Random
			]
		})(),
	...
	oConeheadZombie = InheritO(OrnIZombies, {
		...
		PicArr: (function() {
			...
			return [b + "ConeheadZombie.gif", b + "ConeheadZombieAttack.gif", a + "ZombieLostHead.gif", a +
				"ZombieLostHeadAttack.gif", a + "ZombieHead.gif" + $Random, a + "ZombieDie.gif" + $Random, a + "BoomDie.gif" +
				$Random, a + "Zombie.gif", a + "ZombieAttack.gif"
			]
		})(),
	...
	oPoleVaultingZombie = InheritO(OrnNoneZombies, {
		...
		PicArr: (function() {
			...
			return [a + "PoleVaultingZombie.gif", a + "PoleVaultingZombieAttack.gif", a + "PoleVaultingZombieLostHead.gif", a +
				"PoleVaultingZombieLostHeadAttack.gif", a + "PoleVaultingZombieHead.gif" + $Random, a +
				"PoleVaultingZombieDie.gif" + $Random, a + "BoomDie.gif" + $Random, a + "PoleVaultingZombieWalk.gif", a +
				"PoleVaultingZombieLostHeadWalk.gif", a + "PoleVaultingZombieJump.gif", a + "PoleVaultingZombieJump2.gif"
			]
		})(),
		...
		GoingDieHead: function(c, a, b) {
			oSym.addTask(200, ClearChild, [NewImg(0, a[b.HeadGif] + Math.random(), "left:" + b.X + "px;top:" + (b.pixelTop -
				20) + "px;z-index:" + b.zIndex, EDAll)])
		},
		...
		JudgeAttack: function() {
			...
			for (f = c - 2; f <= c; f++) {
				...
				for (a = 2; a > -1;
					(p = h[d + f + "_" + a--]) && p.canEat && p.AttackedRX >= e && p.AttackedLX < b && (a = -1, g.JudgeAttack =
						CZombies.prototype.JudgeAttack, g.NormalAttack(g.id, p.id))) {}
			}
		},
		getRaven: function(a) {
		...
		NormalAttack: function(d, b) {
			...
			oSym.addTask(100, function(l, j, h, k, r) {
				var q = $Z[l],
					m, n;
				q && ((m = $P[j]) && m.Stature > 0 ? (q.AttackedRX = (q.X = (q.AttackedLX = q.ZX = n = m.AttackedRX) - q.beAttackedPointL) +
					q.beAttackedPointR, SetStyle(h, {
						left: q.X + "px"
					}), r.src = "images/Zombies/PoleVaultingZombie/PoleVaultingZombieWalk.gif", SetBlock(k), q.isAttacking = 0,
					q.Altitude = 1, q.OSpeed = q.Speed = 1.6, q.NormalGif = 7, q.LostHeadGif = 8, q.NormalAttack = CZombies.prototype
					.NormalAttack, q.getRaven = CZombies.prototype.getRaven) : (q.ZX = q.AttackedLX = (q.X = (q.AttackedRX = f) -
						q.beAttackedPointR) + q.beAttackedPointL, SetStyle(h, {
						left: q.X + "px"
					}), r.src = "images/Zombies/PoleVaultingZombie/PoleVaultingZombieJump2.gif" + $Random + Math.random(),
					SetBlock(k), oSym.addTask(80, function(s, u) {
						var t = $Z[s];
						t && (u.src = "images/Zombies/PoleVaultingZombie/PoleVaultingZombieWalk.gif", t.isAttacking = 0, t.Altitude =
							1, t.OSpeed = t.Speed = 1.6, t.NormalGif = 7, t.LostHeadGif = 8, t.NormalAttack = CZombies.prototype.NormalAttack,
	...
	OrnIIZombies = InheritO(CZombies, {
		...
		getHurt: function(h, a, e, l, c, k, j) {
			...
			d.OrnHP ? !h ? (d.OrnHP = Math.max(d.OrnHP - e, 0), d.HP -= e) : h == -1 && !a ? d.OrnHP = Math.max(d.OrnHP - e, 0) :
				d.HP -= e : d.HP -= e;
			switch (true) {
				case !d.OrnHP:
					d.HP -= e;
	...
	oNewspaperZombie = InheritO(OrnIIZombies, {
		...
		PicArr: (function() {
			...
			return [a + "HeadWalk1.gif", a + "HeadAttack1.gif", a + "LostHeadWalk1.gif", a + "LostHeadAttack1.gif", a +
				"HeadWalk0.gif", a + "HeadAttack0.gif", a + "LostHeadWalk0.gif", a + "LostHeadAttack0.gif", a + "Head.gif" +
				$Random, a + "Die.gif" + $Random, a + "BoomDie.gif" + $Random, a + "LostNewspaper.gif"
			]
		})(),
		...
		GoingDie: function(b) {
			...
			oSym.addTask(200, ClearChild, [NewImg(0, a.PicArr[a.HeadGif] + Math.random(), "left:" + a.AttackedLX + "px;top:" +
				(a.pixelTop - 20) + "px;z-index:" + a.zIndex, EDAll)]);
			a.beAttacked = 0;
				...
				if (!j || n == 1) {
					switch (true) {
						...
						case h < 91:
							...
							return;
						default:
							!(e.OrnHP = Math.max(m - g, 0)) && (e.isAttacking = 1, e.FreeSlowTime = "", $(b).childNodes[1].src = d[e.LostPaperGif],
								oSym.addTask(150, function(s, t, r, q) {
					...
					if (j == -1 && !a) {
						!(e.OrnHP = Math.max(m - g, 0)) && (e.isAttacking = 1, $(b).childNodes[1].src = d[e.LostPaperGif], oSym.addTask(
							150,
							function(s, t, r, q) {
